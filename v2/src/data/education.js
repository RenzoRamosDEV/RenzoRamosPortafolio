export const educationItems = [
  ...
  {
    title: "Preparación Intensiva Universitaria",
    company: "PONTIFICIA UNIVERSIDAD CATÓLICA DEL PERÚ",
    period: "2023",
    location: "Lima, Perú",
    desc: "Refuerzo intensivo en matemáticas y competencias lingüísticas, enfocado en consolidar bases para estudios superiores.\n\n- Desarrollo de razonamiento lógico-matemático y resolución de problemas\n- Refuerzo en comprensión lectora y expresión escrita\n- Aplicación de técnicas de análisis, síntesis y estudio estructurado\n- Preparación para evaluaciones de acceso y rendimiento académico\n- Mejora de habilidades de disciplina, organización y pensamiento crítico"
  },
  {
