/**
 * Catálogo de metodologías y prácticas aplicadas.
 *
 * Cada item se agrupa por `cat` (arquitectura, IA, testing, proceso, UI)
 * para que la sección "Forma de trabajar" pueda renderizar columnas
 * temáticas. `label` es el texto corto del chip y `color` su acento.
 *
 * @type {import('../../domain/types.js').MethodologyItem[]}
 */
